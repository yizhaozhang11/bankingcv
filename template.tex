...
%   paper size:  a4paper (default), letterpaper, a5paper, legalpaper, executivepaper, landscape
%   font family: sans (default), roman
%   color:       black, blue (default), burgundy, cerulean, green, grey, orange, purple, red
%   rules:       fullrules, shortrules, mixedrules (default), norules
%   alignment:   left (default), center, right
%   header:      details (default), nodetails
%   icons:       letters-only (legacy symbols/nosymbols options are accepted as no-op)

%\bankingcvcolor{blue}                              % alternative: set color via preamble command
%\bankingcvsetoptions{fullrules, left}              % alternative: set style options via preamble command
...
% the 'contemporary' style is not available in bankingcv
...
% document language
\usepackage[english]{babel}  % FIXME: using spanish breaks bankingcv
